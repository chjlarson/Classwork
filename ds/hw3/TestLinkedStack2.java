...
// TestLinkedStack2.java
// 09/16/14
//
// This program tests the LinkedStack2 program

import jsjf.LinkedStack2;
import jsjf.exceptions.EmptyCollectionException;

public class TestLinkedStack2
{
    ...
    {
        System.out.println("This program tests the LinkedStack2 class.\n");

        System.out.println("Creating a stack using the "
            + "default constructor...");
        LinkedStack2<String> stack1 = new LinkedStack2<String>();
        ...
        LinkedStack2<String> stack2 = new LinkedStack2<String>();
        ...
        System.out.println("\nEnd of testing for the LinkedStack2 class");
    }
}
