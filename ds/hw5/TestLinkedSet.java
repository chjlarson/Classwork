// TestLinkedSet.java
//
// This program tests the LinkedSet implementation of a Set.

import java.util.Iterator;
import java.util.ConcurrentModificationException;
import jsjf.LinkedSet;
...
public class TestLinkedSet
{
    ...
    {
        System.out.println("This program tests the LinkedSet implementation "
            + "of a set.\n");

        // Create an empty set for strings
        LinkedSet<String> testSet = new LinkedSet<String>();
        ...
        System.out.println("Adding 7 more elements for a total of 11.");
        testSet.add("Emma");
        testSet.add("Faith");
        testSet.add("Greg");
        testSet.add("Hank");
        ...
        LinkedSet<String> testSet2 = new LinkedSet<String>();
        testSet2.add("2");
        testSet2.add("4");
        testSet2.add("6");
        testSet2.add("8");
